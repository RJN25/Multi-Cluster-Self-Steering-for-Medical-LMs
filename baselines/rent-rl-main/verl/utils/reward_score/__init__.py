...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None):
    ...
    elif data_source == "math_dapo" or data_source.startswith("aime") or data_source.startswith("Maxwell-Jia") or data_source.startswith("AI-MO"):
    ...
    elif data_source in ["countdown", "Jiayi-Pan/Countdown-Tasks-3to4"]:
